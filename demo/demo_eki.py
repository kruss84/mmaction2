...
def action_inference(timestamp, proposal, model, clip_len, frame_interval, window_size, frames, img_norm_cfg, args,new_h, new_w,label_map):
...
def main():
    ...
    for timestamp, proposal in zip(timestamps, human_detections):
        predictions.append(action_inference(timestamp, proposal, model, clip_len, frame_interval, window_size, frames, img_norm_cfg, args,new_h, new_w,label_map))
